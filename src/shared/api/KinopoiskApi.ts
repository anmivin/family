...
export interface components {
    schemas: {
        ...
        VideoTypes: {
            trailers?: components["schemas"]["Video"][] | null;
        };
        ItemName: {
            name?: string;
        };
        ...
        LinkedMovieV1_4: {
            ...
            type?: string | null;
            poster?: components["schemas"]["ShortImage"] | null;
        ...
        NetworksV1_4: {
            items?: components["schemas"]["NetworkItemV1_4"][] | null;
        };
        MovieDtoV1_4: {
            /**
             ...
             */
            id?: number | null;
            externalId?: components["schemas"]["ExternalId"] | null;
            ...
            /** @example Spider man */
            enName?: string | null;
            names?: components["schemas"]["Name"][] | null;
            /**
             ...
             */
            status?: string | null;
            facts?: components["schemas"]["FactInMovie"][] | null;
            ...
            similarMovies?: components["schemas"]["LinkedMovieV1_4"][] | null;
            sequelsAndPrequels?: components["schemas"]["LinkedMovieV1_4"][] | null;
             ...
             */
            lists?: string[] | null;
            networks?: components["schemas"]["NetworksV1_4"] | null;
            /** Format: date-time */
        ...
        SearchMovieDtoV1_4: {
            ...
            logo?: components["schemas"]["Logo"] | null;
            poster?: components["schemas"]["ShortImage"] | null;
            backdrop?: components["schemas"]["ShortImage"] | null;
            rating?: components["schemas"]["Rating"] | null;
            votes?: components["schemas"]["Votes"] | null;
            genres?: components["schemas"]["ItemName"][] | null;
            countries?: components["schemas"]["ItemName"][] | null;
            releaseYears?: components["schemas"]["YearRange"][] | null;
            isSeries?: boolean | null;
            ticketsOnSale?: boolean | null;
            totalSeriesLength?: number | null;
            seriesLength?: number | null;
        ...
        Nomination: {
            award?: components["schemas"]["NominationAward"] | null;
            title?: string | null;
        };
        MovieAward: {
            nomination?: components["schemas"]["Nomination"] | null;
        ...
        MovieAwardDocsResponseDto: {
            docs: components["schemas"]["MovieAward"][];
            /** @description Общее количество результатов */
            total: number;
            /** @description Количество результатов на странице */
            limit: number;
        ...
        PersonAward: {
            ...
            createdAt?: string | null;
            personId: number;
            movie?: components["schemas"]["Movie"] | null;
        };
        ...
        List: {
            ...
            cover?: components["schemas"]["ShortImage"] | null;
            name: string;
            /** Format: date-time */
            updatedAt: string;
            /** Format: date-time */
    ...
    MovieController_findManyAwardsV1_4: {
        parameters: {
            query?: {
                ...
                /** @description Список полей которые не должны быть null или пусты */
                notNullFields?: ("movieId" | "winning" | "nomination.award.title" | "nomination.award.year" | "nomination.title" | "updatedAt" | "createdAt")[];
                /** @description Сортировка по полям из модели */
                sortField?: ("movieId" | "winning" | "nomination.award.title" | "nomination.award.year" | "nomination.title" | "updatedAt" | "createdAt")[];
                /** @description Тип сортировки применительно к полям из sortField (пример: `"1", "-1"`) */
                sortType?: string[];
    ...
    SeasonController_findManyV1_4: {
        parameters: {
            query?: {
                ...
                limit?: number;
                /** @description Список полей требуемых в ответе из модели */
                selectFields?: ("movieId" | "poster" | "number" | "name" | "enName" | "duration" | "description" | "enDescription" | "episodesCount" | "airDate" | "episodes" | "updatedAt" | "createdAt")[];
                /** @description Список полей которые не должны быть null или пусты */
                notNullFields?: ("movieId" | "poster.url" | "poster.previewUrl" | "number" | "name" | "enName" | "episodesCount" | "airDate" | "duration" | "description" | "enDescription" | "episodes.number" | "episodes.name" | "episodes.enName" | "episodes.airDate" | "episodes.date" | "episodes.description" | "episodes.enDescription" | "updatedAt" | "createdAt")[];
                /** @description Сортировка по полям из модели */
                sortField?: ("movieId" | "poster.url" | "poster.previewUrl" | "number" | "name" | "enName" | "episodesCount" | "airDate" | "duration" | "description" | "enDescription" | "episodes.number" | "episodes.name" | "episodes.enName" | "episodes.airDate" | "episodes.date" | "episodes.description" | "episodes.enDescription" | "updatedAt" | "createdAt")[];
                /** @description Тип сортировки применительно к полям из sortField (пример: `"1", "-1"`) */
                sortType?: string[];
                /** @description Поиск по ID фильма (пример: `"666", "555", "!666"`) */
                movieId?: string[] | null;
    ...
    ReviewController_findManyV1_4: {
        parameters: {
            query?: {
                ...
                limit?: number;
                /** @description Список полей требуемых в ответе из модели */
                selectFields?: ("id" | "movieId" | "title" | "type" | "review" | "date" | "author" | "authorId" | "updatedAt" | "createdAt")[];
                /** @description Список полей которые не должны быть null или пусты */
                notNullFields?: ("id" | "movieId" | "title" | "type" | "review" | "date" | "author" | "authorId" | "updatedAt" | "createdAt")[];
                /** @description Сортировка по полям из модели */
                sortField?: ("id" | "movieId" | "title" | "type" | "review" | "date" | "author" | "authorId" | "updatedAt" | "createdAt")[];
                /** @description Тип сортировки применительно к полям из sortField (пример: `"1", "-1"`) */
                sortType?: string[];
    ...
    PersonController_findManyV1_4: {
        parameters: {
            query?: {
                ...
                limit?: number;
                /** @description Список полей требуемых в ответе из модели */
                selectFields?: ("id" | "name" | "enName" | "photo" | "sex" | "growth" | "birthday" | "death" | "age" | "birthPlace" | "deathPlace" | "spouses" | "countAwards" | "profession" | "facts" | "movies" | "updatedAt" | "createdAt")[];
                /** @description Список полей которые не должны быть null или пусты */
    ...
    PersonController_findManyAwardsV1_4: {
        parameters: {
            query?: {
                ...
                limit?: number;
                /** @description Список полей требуемых в ответе из модели */
                selectFields?: ("personId" | "winning" | "nomination" | "movies" | "updatedAt" | "createdAt")[];
                /** @description Список полей которые не должны быть null или пусты */
                notNullFields?: ("personId" | "winning" | "nomination.award.title" | "nomination.award.year" | "nomination.title" | "movies.id" | "updatedAt" | "createdAt")[];
                /** @description Сортировка по полям из модели */
                sortField?: ("personId" | "winning" | "nomination.award.title" | "nomination.award.year" | "nomination.title" | "movies.id" | "updatedAt" | "createdAt")[];
                /** @description Тип сортировки применительно к полям из sortField (пример: `"1", "-1"`) */
                sortType?: string[];
    ...
    ImageController_findManyV1_4: {
        parameters: {
            query?: {
                ...
                limit?: number;
                /** @description Список полей требуемых в ответе из модели */
                selectFields?: ("movieId" | "type" | "language" | "url" | "previewUrl" | "height" | "width" | "updatedAt" | "createdAt")[];
                /** @description Список полей которые не должны быть null или пусты */
                notNullFields?: ("movieId" | "type" | "language" | "url" | "previewUrl" | "height" | "width" | "updatedAt" | "createdAt")[];
                /** @description Сортировка по полям из модели */
                sortField?: ("movieId" | "type" | "language" | "url" | "previewUrl" | "height" | "width" | "updatedAt" | "createdAt")[];
                /** @description Тип сортировки применительно к полям из sortField (пример: `"1", "-1"`) */
                sortType?: string[];
    ...
    ListController_findManyV1_4: {
        parameters: {
            query?: {
                ...
                /** @description Список полей которые не должны быть null или пусты */
                notNullFields?: ("name" | "category" | "slug" | "moviesCount" | "cover.url" | "cover.previewUrl" | "updatedAt" | "createdAt")[];
                /** @description Сортировка по полям из модели */
                sortField?: ("name" | "category" | "slug" | "moviesCount" | "cover.url" | "cover.previewUrl" | "updatedAt" | "createdAt")[];
                /** @description Тип сортировки применительно к полям из sortField (пример: `"1", "-1"`) */
                sortType?: string[];
                /** @description Поиск slug (пример: `"!top250", "top250"`) */
                slug?: string[] | null;
